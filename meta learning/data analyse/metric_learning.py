...
sample_idxs = np.random.randint(0, 1450, size=(5, 5))
...
class EmbeddingModel(keras.Model):
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            # This value would normally be chosen as a hyperparameter.
            temperature = 0.2
...
x = layers.Conv2D(filters=32, kernel_size=11, strides=4, activation="relu")(inputs)
...
history = model.fit(AnchorPositivePairs(num_batchs=64), epochs=20)
