...
class EasySet(FewShotDataset):
    ...
    def __init__(
        ...
        Args:
            ...
            transform: torchvision transforms to be applied to image. If none is provided,
    ...
    def __getitem__(self, item: int):
        ...
        Returns:
            ...
            The type of the image object depends on the output type of self.transform. By default,
